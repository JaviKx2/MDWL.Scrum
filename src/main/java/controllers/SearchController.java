...
public class SearchController {
    ...
    public List<AvailabilityWrapper> search(String hotelName, String city, String postCode, Date slotStartDate, Date slotEndDate){
        List<Availability> availabilities = availibilityDao.search(hotelName, city, postCode, slotStartDate, slotEndDate);
